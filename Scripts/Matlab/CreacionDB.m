...
exec(conexionDB, 'CREATE TABLE Registros(ID INT NOT NULL PRIMARY KEY, Codigo VARCHAR(20) NOT NULL, Nombre VARCHAR(50), Fecha DATE NOT NULL, Turno INT NOT NULL, Tipo VARCHAR(50) NOT NULL, Cantidad FLOAT, KGs FLOAT)');
...
while ischar(fileLine) %Mientras tengamos datos en el archivo...
    ...
    switch parsedLine{1} %Si el primer campo es de tipo...
        ...
        case '[registro]' %registro, vamos a su funcion
